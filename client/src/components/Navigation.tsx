/**
 * Navigation — "Clean White Authority" design system
 * Minimal top nav: logo left, links right, phone number
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/">
            <div className="flex flex-col leading-none">
              <span
                ...
                className="text-[#111111] text-xl md:text-2xl tracking-tight"
              >
                FlashPreviews
              </span>
              <span
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
                className="text-[#B8860B] text-[0.55rem] tracking-[0.25em] uppercase"
              >
                Consulting Group
              </span>
            </div>
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <a
              href="tel:3104373343"
              style={{ fontFamily: "'JetBrains Mono', monospace" }}
              className="text-[0.75rem] text-[#444444] tracking-wider"
            >
              (310) 437-3343
            </a>
